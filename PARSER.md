...
- Диапазоны 0–500000 тем, альбомов и пользователей проходятся полностью при каждом запуске; оптимизация «пропускать неизменённые» — отдельная задача (TODO 10 в README, «постоянно живущий парсер»)
